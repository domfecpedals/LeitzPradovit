	...
	public void setFocusMode(Context item, int type) {
		...
		case 0:
			if (FocusModes.contains(Camera.Parameters.FOCUS_MODE_AUTO))
				...
				Toast.makeText(item, "Auto Mode not supported",
		...
		case 1:
			if (FocusModes
				...
				Toast.makeText(item, "Continuous Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 2:
			if (FocusModes.contains(Camera.Parameters.FOCUS_MODE_EDOF))
				...
				Toast.makeText(item, "EDOF Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 3:
			if (FocusModes.contains(Camera.Parameters.FOCUS_MODE_FIXED))
				...
				Toast.makeText(item, "Fixed Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 4:
			if (FocusModes.contains(Camera.Parameters.FOCUS_MODE_INFINITY))
				...
				Toast.makeText(item, "Infinity Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 5:
			if (FocusModes.contains(Camera.Parameters.FOCUS_MODE_MACRO))
				...
				Toast.makeText(item, "Macro Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		}
	...
	public void setFlashMode(Context item, int type) {
		...
		case 1:
			if (FlashModes.contains(Camera.Parameters.FLASH_MODE_OFF))
				...
				Toast.makeText(item, "Off Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 2:
			if (FlashModes.contains(Camera.Parameters.FLASH_MODE_ON))
				...
				Toast.makeText(item, "On Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 3:
			if (FlashModes.contains(Camera.Parameters.FLASH_MODE_RED_EYE))
				...
				Toast.makeText(item, "Red Eye Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		case 4:
			if (FlashModes.contains(Camera.Parameters.FLASH_MODE_TORCH))
				...
				Toast.makeText(item, "Torch Mode not supported",
						Toast.LENGTH_SHORT).show();
			break;
		}
